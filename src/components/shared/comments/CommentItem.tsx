...
import type { BaseComment } from '@/types/comments';
import { cn } from '@/lib/utils';
import { CommentStatic } from './CommentStatic';
import { CommentVoteButton } from './CommentVoteButton';
import { PinnedBadge } from '@/components/questoes/comments/PinnedBadge';
import { EndorsedBadge } from '@/components/questoes/comments/EndorsedBadge';
import { CommentContextMenu } from './CommentContextMenu';
import { CommentReactionButtons } from './CommentReactionButtons';
import { InlineReportBadge } from '@/components/questoes/comments/InlineReportBadge';
...
interface CommentItemProps {
  ...
  /** ISO date string — if comment was created before this threshold, show a warning badge */
