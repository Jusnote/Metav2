...
function EquationInput(props: React.ComponentProps<typeof TextareaAutosize> & {
  state: { isInline?: boolean; open?: boolean; onClose?: () => void };
}) {
  const { state, ref, ...restProps } = props;
  const inputProps = useEquationInput(state);
  
  return <TextareaAutosize {...inputProps} {...restProps} ref={ref as any} />;
}
