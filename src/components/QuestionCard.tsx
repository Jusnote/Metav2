  ...
  return (
    <article ref={articleRef} className="qc-card-enter text-left">
      ...
      <div className="px-5 pt-3 pb-5" ref={questionBodyRef}>
        ...
        >
          <div
            className="prose prose-sm prose-zinc dark:prose-invert max-w-none text-[#2d3748] dark:text-zinc-100 leading-[1.8] text-[15.5px] [&_p]:text-[15.5px] [&_p]:leading-[1.8] [&_p]:my-1 text-left"
