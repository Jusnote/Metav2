...
describe('HighlightNotePopover', () => {
  it('mostra o tipo atual e troca via dropdown chamando onChange', () => {
    ...
    render(<HighlightNotePopover highlight={base} onChange={onChange} onRemove={() => {}} onClose={() => {}} />);
  ...
  it('auto-save: digitar e disparar onClose salva a nota', () => {
    const onChange = vi.fn();
    const onClose = vi.fn();
    render(<HighlightNotePopover highlight={base} onChange={onChange} onRemove={() => {}} onClose={onClose} />);
  ...
  it('lixeira chama onRemove', () => {
    ...
    render(<HighlightNotePopover highlight={base} onChange={() => {}} onRemove={onRemove} onClose={() => {}} />);
