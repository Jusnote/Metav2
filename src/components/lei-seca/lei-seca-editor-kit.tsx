...
export type LeiSecaEditor = TPlateEditor<Value, (typeof LeiSecaEditorKit)[number]>;

export const useLeiSecaEditor = () => useEditorRef<LeiSecaEditor>();
