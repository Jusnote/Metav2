...
export const MOCK_CARREIRAS: Carreira[] = [
  // ─── Advocacia ──────────────────────────────────────────────
  { id: 'mock-oab',           area: 'advocacia',   nome: 'OAB · Exame de Ordem', slug: 'oab-exame',    foto_url: 'https://static.vecteezy.com/ti/fotos-gratis/t2/79108606-masculino-advogado-dentro-preto-terno-falando-em-a-telefone-as-escrivaninha-com-computador-portatil-e-tabua-senhora-justica-estatua-dentro-primeiro-plano-moderno-escritorio-configuracao-com-de-madeira-acentos-gratis-foto.jpg', ordem: 1,  ativa: true, created_at: now, updated_at: now },
